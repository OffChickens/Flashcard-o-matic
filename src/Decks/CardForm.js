...
function CardForm({ handleSubmit, cardData, handleChange, deckId}) {
    const history = useHistory();
    return (
        <form onSubmit={(handleSubmit)}>
        <div className="col-12">
            <label for="front" className="form-label my-2">Front</label>
        ...
        <div className="col-12">
            <label for="back" className="form-label my-2">Back</label>
